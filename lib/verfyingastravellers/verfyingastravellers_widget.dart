...
class _VerfyingastravellersWidgetState
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('verfyingastravellers_update_page_state');
      setState(() {
                                        ...
                                        children: [
                                          ...
                                          FlutterFlowDropDown<String>(
                                            controller: _model
                                                ...
                                                FormFieldController<String>(
                                              _model.dropDownValue3 ??= 'Hour',
                                            ),
                                            options: ['Hour', 'Trip', 'Person'],
