                        ...
                        Align(
                          ...
                          child: Container(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'EDIT_PROFILE_PAGE_Icon_opwsbmhi_ON_TAP');
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'EDIT_PROFILE_PAGE_PhotoUpload_ON_TAP');
                                            logFirebaseEvent(
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EDIT_PROFILE_Container_0gpmtdyi_ON_TAP');
                                          logFirebaseEvent(
                                        ...
                                        child: Container(
                                          ...
                                          child: FlutterFlowDropDown<String>(
                                            ...
                                            onChanged: (val) async {
                                              ...
                                              logFirebaseEvent(
                                                  'EDIT_PROFILE_DropDown_8gsnd8of_ON_FORM_W');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'EDIT_PROFILE_PAGE_Image_4ca17qfa_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Image_update_app_state');
                                                                    setState(
                                                                        () {
                                                                      FFAppState()
                                                                          .removeFromGuidecities(
                                                                              citiesselectedItem);
                                                                    });
                                                                  },
                                                                  child: Image
                        ...
                        children: [
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'EDIT_PROFILE_PAGE_NEXT_BTN_ON_TAP');
                                if ((_model.nameInputController.text != null &&
                                        _model.nameInputController.text !=
                                            '') &&
                                    (_model.titleInputController.text != null &&
                                  ...
                                  await currentUserReference!
                                    ...
                                    dob: FFAppState().dateofbirth,
                                    type: _model.choiceChipsValue,
                                  ));
                                  logFirebaseEvent('Button_navigate_to');

                                  context.pushNamed('createyourprofile2');
