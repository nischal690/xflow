                ...
                children: [
                  Container(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'POSTDETAILS_PAGE_Icon_6vtmr1qf_ON_TAP');
                  ...
                  InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('POSTDETAILS_PAGE_Row_b8i6thn3_ON_TAP');
                  ...
                  Container(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'POSTDETAILS_PAGE_Icon_g2frddcq_ON_TAP');
                        logFirebaseEvent('Icon_navigate_to');
                                                                      ...
                                                                      if (stackUserspostRecord
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                              Visibility(
                                                                            visible:
                                                                                stackUserspostRecord.tag == 'Adventure',
                                                                            child:
                                                                                Align(
                                                                              alignment: AlignmentDirectional(0.0, 0.0),
                                                                              child: Padding(
