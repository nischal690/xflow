                      ...
                      return SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: StreamBuilder<List<InterestRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<InterestRecord> wrapInterestRecordList =
                                      snapshot.data!;
                                  return Wrap(
                                    spacing: 8.0,
                                    runSpacing: 8.0,
                              ...
                              StreamBuilder<List<UserspostRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<UserspostRecord>
                                      postsUserspostRecordList = snapshot.data!;
                                  return ListView.builder(
                                    padding: EdgeInsets.zero,
                                    shrinkWrap: true,
                                    scrollDirection: Axis.vertical,
                                    itemCount: postsUserspostRecordList.length,
                                    itemBuilder: (context, postsIndex) {
                                      final postsUserspostRecord =
                                          postsUserspostRecordList[postsIndex];
                            ...
                            if (FFAppState().posts && FFAppState().followers)
                              AuthUserStreamWidget(
                                builder: (context) => Builder(
                                  builder: (context) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder: (context, followingsIndex) {
